...
document.addEventListener('DOMContentLoaded', () => {
    console.log(">>> Kyrosil Bot v158 (Cmd Return Fix) çalıştı! <<<"); // Önceki versiyon notu kalmış olabilir, önemli değil
    ...
    // === allowedSocialMedia BURADA TANIMLI! ===
        ...
        if (messageText !== "") {
            ...
            // --- State Handling Bitti ---
                ...
                if (messageText.startsWith('/')) {
                    ...
                    // Bilinen bir komut işlendiyse API'ye gitme
